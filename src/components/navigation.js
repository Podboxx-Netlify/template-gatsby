...
export default (props) => {
    ...
    return (
        <div className="navigation">
            ...
            {data.site.siteMetadata.youtube !== "null" ? <a href={data.site.siteMetadata.youtube} rel="noreferrer" target="_blank"><img style={{width: 50}} alt="youtube" src={youtube}/></a> : ""}
            ...
            {data.site.siteMetadata.twitter !== "null" ? <a href={data.site.siteMetadata.twitter} rel="noreferrer" target="_blank"><img style={{width: 50}} alt="twitter" src={twitter}/></a> : ""}
            {data.site.siteMetadata.linkedin !== "null" ? <a href={data.site.siteMetadata.linkedin} rel="noreferrer" target="_blank"><img style={{width: 50}} alt="linkedin" src={linkedin}/></a> : ""}
        </div>
    )
}
